...
class PersonController {
    ...
    def save() {
		...
		personInstance.setPassword(springSecurityService.encodePassword(personInstance.getPassword()))
		...
		def personStudy = new PersonStudy(person: personInstance, study: study,
	...
	def studies(Long id) {
		def personInstance = Person.get(id)
		Set<PersonStudy> studies = personInstance.getStudies()
