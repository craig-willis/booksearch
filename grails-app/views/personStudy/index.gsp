...
<html>
	...
	<body>
		...
		<div id="available-studies-intro" class="content">
			You are eligible to participate in the following studies. To begin a new study or resume a previously saved session, select the study name link.
		</div>
			...
			<table>
				...
				<g:each in="${studyList}" status="i" var="study">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: study.study, field: "description")}</td>
